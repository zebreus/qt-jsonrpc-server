  ...
  switch(arguments.size()) {
    ...
    case 3:
      method.invoke(processor,
                    Qt::AutoConnection,
                    returnArgument,
                    arguments[0]->getArgument(),
                    arguments[1]->getArgument(),
                    arguments[2]->getArgument());
      break;
    case 4:
      method.invoke(processor,
                    Qt::AutoConnection,
