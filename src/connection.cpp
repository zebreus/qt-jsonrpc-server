    ...
    QObject(parent), processor(target), webSocket(webSocket)
{
    ...
    connect(webSocket, &QWebSocket::textMessageReceived,
        this, &Connection::receiveIncomingMessage);
    connect(webSocket, &QWebSocket::disconnected,
        this, &Connection::disconnect);
    connect(messageProcessor, &MessageProcessor::outgoingMessage,
        this, &Connection::receiveOutgoingMessage);
    connect(this, &Connection::incomingMessage,
        messageProcessor, &MessageProcessor::processIncomingMessage);
}
